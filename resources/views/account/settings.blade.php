                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="image-input image-input-outline" data-kt-image-input="true"
                                    ...
                                    <!-- <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{ getUserPhoto(\Auth::user()->id) }})"></div> -->
                                    <img class="image-input-wrapper w-125px h-125px"
                                        src="{{ asset(getUserPhoto(\Auth::user()->id)) }} "
                                        alt="{{ getUserUuid(\Auth::user()->id) }} "
