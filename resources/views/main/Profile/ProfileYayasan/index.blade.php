                ...
                <div class="col-lg-12">
                    <div class="about-left-content">
                        <div class="section-title">
                            <span class="text-uppercase">Profile | Profile Yayasan</span>
                            <h2>
                                <span>Profile </span>
                                <span class="primary-color">Yayasan</span>
                            </h2>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="section-title">
                        <h3>Struktur
                            <span class="primary-color">Organisasi</span>
                        </h3>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="tch-left-thumb">
                        <img src="{{ asset('assets/media/images/Picture1.png') }}" class="border p-2" alt="image">
                    </div>
                </div>
            </div>
        </div>
