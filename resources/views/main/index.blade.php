...
@section('content')
    <div class="slider-area owl-carousel has-color" data-left-arrow="{{ asset('assets/media/images/angle-left.png') }}"
        ...
        <div class="slider_item"
            style="
          background: url({{ asset('assets/media/images/bg/slider-bg2.jpg') }}) center/cover
            no-repeat;
        ">
            <div class="container">
                <div class="row">
        ...
        <div class="slider_item"
            style="
          background: url({{ asset('assets/media/images/bg/slider-bg3.jpg') }}) center/cover
            no-repeat;
        ">
            <div class="container">
                <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="about-left-content">
                        <div class="section-title">
                            ...
                            <h2>
                                <span>Our </span>
                                <span class="primary-color">university</span>
                            </h2>
                        </div>
                        <p>
        ...
        <div class="container">
            ...
            <div class="commn-carousel owl-carousel card-deck">
                <div class="card mb-5">
                    ...
                    <div class="card-body teacher-content p-25">
                        <h4 class="card-title mb-4">
                            <a href="teacher-details.html">Patrick Garner Dony</a>
                        </h4>
                ...
                <div class="card mb-5">
                    ...
                    <div class="card-body teacher-content p-25">
                        <h4 class="card-title mb-4">
                            <a href="teacher-details.html">Cameron Brown</a>
                        </h4>
                ...
                <div class="card mb-5">
                    ...
                    <div class="card-body teacher-content p-25">
                        <h4 class="card-title mb-4">
                            <a href="teacher-details.html">Joseph Mack Monika</a>
                        </h4>
                ...
                <div class="blog-carousel owl-carousel card-deck">
                    <div class="card mb-5">
                        ...
                        <div class="card-body p-25">
                            ...
                            <h4 class="card-title mb-4">
                                <a href="blog-details.html">The Death Of architechture</a>
                            </h4>
                            <p class="card-text">
                                We’re a philosophical bunch here at School site and we have
                                thought long and hard about.
                    ...
                    <!-- card -->
                    <div class="card mb-5">
                        <img class="card-img-top" src="{{ asset('assets/media/images/blog/blog-thumbnail2.jpg') }}" alt="image" />
                        <div class="card-body p-25">
                            <ul class="list-inline primary-color mb-3">
                                <li><i class="fa fa-clock-o"></i> AUGUST 6, 2017</li>
                                <li><i class="fa fa-comments"></i> 3 Comments</li>
                            ...
                            <h4 class="card-title mb-4">
                                <a href="blog-details.html">Aenean id ullamcorper</a>
                            </h4>
                            <p class="card-text">
                                We’re a philosophical bunch here at School site and we have
                                thought long and hard about.
                    ...
                    <div class="card mb-5">
                        <img class="card-img-top" src="{{ asset('assets/media/images/blog/blog-thumbnail3.jpg') }}" alt="image" />
                        <div class="card-body p-25">
                            <ul class="list-inline primary-color mb-3">
                                <li><i class="fa fa-clock-o"></i> AUGUST 6, 2017</li>
                                <li><i class="fa fa-comments"></i> 3 Comments</li>
                    ...
                    <!-- card -->
                    <div class="card mb-5">
                        <img class="card-img-top" src="{{ asset('assets/media/images/blog/blog-thumbnail1.jpg ') }}" alt="image" />
                        <div class="card-body p-25">
                            <ul class="list-inline primary-color mb-3">
                                <li><i class="fa fa-clock-o"></i> AUGUST 6, 2017</li>
                                <li><i class="fa fa-comments"></i> 3 Comments</li>
