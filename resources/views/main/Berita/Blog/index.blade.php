                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card mb-5">
                        ...
                        <div class="card-body p-25">
                            ...
                            <h4 class="card-title mb-4"><a href="{{ route('berita.blog.detil', [1]) }}">The Death Of
                                    architechture</a></h4>
                            <p class="card-text">We’re a philosophical bunch here at School site and we have thought long
                                and hard about.</p>
                            <a class="btn btn-primary btn-round btn-sm" href="{{ route('berita.blog.detil', [1]) }}"> Baca
                                Selengkapnya </a>
                        </div>
                    </div><!-- card -->
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card mb-5">
                        ...
                        <div class="card-body p-25">
                            ...
                            <h4 class="card-title mb-4"><a href="{{ route('berita.blog.detil', [1]) }}">Aenean id
                                    ullamcorper</a>
                            </h4>
                            <p class="card-text">We’re a philosophical bunch here at School site and we have thought long
                                and hard about.</p>
